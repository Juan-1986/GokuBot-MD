...
- En caso de un error ocurrente, puedes ir aqui para apelar la suspensión.
*Intenta Quitar El Baneo Aqui:* wa.me/51929838430
               `.trim();
              m.reply(messageText);
          ...
          if (botSpam.antispam && m.text && user && user.lastCommandTime && (Date.now() - user.lastCommandTime) < 30000 && !isROwner) {
            if (user.commandCount === 2) {
              ...
              if (remainingTime > 0) {
                const messageText = `*Espere ${remainingTime} para volver a usar otro comando.`;
                m.reply(messageText);
                return;
              } else {
                user.commandCount = 0;
...
export async function callUpdate(callUpdate) {
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        const callmsg = await mconn.conn.reply(nk.from, `𝙃𝙤𝙡𝙖 *@${nk.from.split('@')[0]}*, 𝙣𝙤 𝙚𝙨𝙩𝙖𝙣 𝙥𝙚𝙧𝙢𝙞𝙩𝙞𝙙𝙖𝙨 𝙡𝙖𝙨 ${nk.isVideo ? '𝙫𝙞𝙙𝙚𝙤 𝙡𝙡𝙖𝙢𝙖𝙙𝙖𝙨' : '𝙡𝙡𝙖𝙢𝙖𝙙𝙖𝙨'} 𝙚𝙣 𝙚𝙨𝙩𝙚 𝙗𝙤𝙩, 𝙨𝙚𝙧𝙖𝙨 𝙗𝙡𝙤𝙦𝙪𝙚𝙙𝙤.\n\n- 𝙀𝙣 𝙘𝙖𝙨𝙤 𝙙𝙚 𝙪𝙣 𝙚𝙧𝙧𝙤𝙧, 𝙥𝙪𝙚𝙙𝙚𝙨 𝙖𝙥𝙚𝙡𝙖𝙧 𝙚𝙨𝙩𝙤 𝙘𝙤𝙣𝙩𝙖𝙘𝙩𝙖𝙣𝙙𝙤𝙩𝙚 𝙘𝙤𝙣 𝙚𝙡 𝙘𝙧𝙚𝙖𝙙𝙤𝙧 𝙙𝙚𝙡 𝙗𝙤𝙩:\n${creador}`, false, {mentions: [nk.from]});
        // let data = global.owner.filter(([id, isCreator]) => id && isCreator)
        // await this.sendContact(nk.from, data.map(([id, name]) => [id, name]), false, { quoted: callmsg })
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝙂𝙤𝙠𝙪𝘽𝙤𝙩 𝘾𝙧𝙚𝙖𝙩𝙤𝙧 🏷️;;;\nFN:𝙂𝙤𝙠𝙪𝘽𝙤𝙩 𝘾𝙧𝙚𝙖𝙩𝙤𝙧 🏷️\nORG:𝙂𝙤𝙠𝙪𝘽𝙤𝙩 𝘾𝙧𝙚𝙖𝙩𝙤𝙧 🏷️\nTITLE:\nitem1.TEL;waid=+573108625104:+57 310 8625104\nitem1.X-ABLabel:𝙂𝙤𝙠𝙪𝘽𝙤𝙩 𝘾𝙧𝙚𝙖𝙩𝙤𝙧 🏷️\nX-WA-BIZ-DESCRIPTION:Solo contacteme si hay un error.\nX-WA-BIZ-NAME:𝙂𝙤𝙠𝙪𝘽𝙤𝙩 𝘾𝙧𝙚𝙖𝙩𝙤𝙧 🏷️\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, {contacts: {displayName: '𝙂𝙤𝙠𝙪𝘽𝙤𝙩 𝘾𝙧𝙚𝙖𝙩𝙤𝙧 🏷️', contacts: [{vcard}]}}, {quoted: callmsg});
...
global.dfail = (type, m, conn) => {
  const msg = {
    private: '•─• ⊹〘👤 𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔 👤〙⊹ •─•\n\n🏷️⃟⸽✯› 𝘌𝘚𝘛𝘌 𝘊𝘖𝘔𝘈𝘕𝘋𝘖 𝘚𝘖𝘓𝘖 𝘗𝘜𝘌𝘋𝘌 𝘚𝘌𝘙 𝘜𝘛𝘐𝘓𝘐𝘡𝘈𝘋𝘖 𝘌𝘕 𝘊𝘏𝘈𝘛𝘚 𝘗𝘙𝘐𝘝𝘈𝘋𝘖𝘚.',
    admin: '•─• ⊹〘👤 𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔 👑〙⊹ •─•\n\n🏷️⃟⸽✯› 𝘌𝘚𝘛𝘌 𝘊𝘖𝘔𝘈𝘕𝘋𝘖 𝘚𝘖𝘓𝘖 𝘗𝘜𝘌𝘋𝘌 𝘚𝘌𝘙 𝘜𝘛𝘐𝘓𝘐𝘡𝘈𝘋𝘖 𝘗𝘖𝘙 𝘓𝘖𝘚 𝘈𝘋𝘔𝘐𝘕𝘚 𝘋𝘌𝘓 𝘎𝘙𝘜𝘗𝘖..',
    botAdmin: '•─• ⊹〘🤖 𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔 👑〙⊹ •─•\n\n🏷️⃟⸽✯› 𝘌𝘚𝘛𝘌 𝘊𝘖𝘔𝘈𝘕𝘋𝘖 𝘚𝘖𝘓𝘖 𝘗𝘜𝘌𝘋𝘌 𝘚𝘌𝘙 𝘜𝘛𝘐𝘓𝘐𝘡𝘈𝘋𝘖 𝘚𝘐 𝘌𝘓 𝘉𝘖𝘛 𝘌𝘚 𝘈𝘋𝘔𝘐𝘕 𝘋𝘌𝘓 𝘎𝘙𝘜𝘗𝘖.',
    unreg: '•─• ⊹〘🗃️ 𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔 🗃️〙⊹ •─•\n\n🏷️⃟⸽✯› 𝘙𝘌𝘎𝘐𝘚𝘛𝘙𝘌𝘚𝘌 𝘗𝘈𝘙𝘈 𝘗𝘖𝘋𝘌𝘙 𝘜𝘚𝘈𝘙 𝘌𝘚𝘛𝘌 𝘊𝘖𝘔𝘈𝘕𝘋𝘖.\n\n𝗘𝗝𝗘𝗠𝗣𝗟𝗢𝗦:\n\n1) *#reg Nombre.Edad*\n\n2) *#reg GokuBot.23*',
    restrict: '•─• ⊹〘🛑 𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔 🛑〙⊹ •─•\n\n🏷️⃟⸽✯› 𝘓𝘈𝘚 𝘙𝘌𝘚𝘛𝘙𝘐𝘊𝘊𝘐𝘖𝘕𝘌𝘚 𝘋𝘌𝘓 𝘉𝘖𝘛 𝘌𝘚𝘛𝘈𝘕 𝘋𝘌𝘚𝘈𝘊𝘛𝘐𝘝𝘈𝘋𝘈𝘚.\n\n𝗔𝗖𝗧𝗜𝗩𝗔𝗟𝗢𝗦 𝗖𝗢𝗡:\n#on restrict',
    }[type];
  const aa = {quoted: m, userJid: conn.user.jid};
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '⚡ ' + wm + ' ⚡', body: 'Advertencias del bot', thumbnail: gokuMenu1, sourceUrl: canal1}}}}, aa);
