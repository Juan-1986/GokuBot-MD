...
user.warn += 1
if (!(user.warn >= 4)) {
await conn.reply(m.chat, `Decir esa palabra esta prohibida.`, m)
await conn.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: bang, participant: delet }})
}

if (user.warn >= 4) {
if (chat.delete) return conn.reply(m.chat, `Desactiva el comando anti delete, para que el bot no envie mensajes eliminados`, m)
user.warn = 0
