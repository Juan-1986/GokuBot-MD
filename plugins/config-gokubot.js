...
await conn.sendButton(m.chat, `${wm}\n\n🏷️ 𝗢𝗣𝗖𝗜𝗢𝗡: ${type} \n🗃️ 𝗖𝗢𝗠𝗔𝗡𝗗𝗢: ${isEnable ? '𝖠𝖼𝗍𝗂𝗏𝖺𝖽𝗈' : '𝖣𝖾𝗌𝖺𝖼𝗍𝗂𝗏𝖺𝖽𝗈'}\n🤖 𝗣𝗔𝗥𝗔: ${isAll ? '𝖦𝗈𝗄𝗎𝖡𝗈𝗍-𝖬𝖣' : isUser ? '' : '𝖤𝗌𝗍𝖾 𝖼𝗁𝖺𝗍'}`, wm, null, [[`${isEnable ? '𝖠𝗉𝖺𝗀𝖺𝗋 ❌' : '𝖠𝖼𝗍𝗂𝗏𝖺𝗋 ✅'}`, `${isEnable ? `.off ${type}` : `.on ${type}`}`], null, null, null, fkontak)}
