...
const doxeo = `𝙋𝙀𝙍𝙎𝙊𝙉𝘼 𝘿𝙊𝙓𝙀𝘼𝘿𝘼 𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊!!\n\n*𝙏𝙞𝙚𝙢𝙥𝙤: ${executionTime} segundos.*\n*• Resultados obtenidos del doxeo:*
...
"𝙊𝙗𝙩𝙚𝙣𝙞𝙚𝙣𝙙𝙤 𝙙𝙖𝙩𝙤𝙨... 🕛"
      ...
      let { key } = await conn.sendMessage(m.chat, {text: `• 𝙄𝙉𝙄𝘾𝙄𝘼𝙉𝘿𝙊 𝘿𝙊𝙓𝙀𝙊...`}, {quoted: m})
